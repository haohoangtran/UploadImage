...
public class GarellyActivity extends AppCompatActivity {
    ...
    public void setBtSummit(File file)  {
        ...
        String s=cloudinary.url().transformation(new Transformation().crop("crop").gravity("face")
        ).imageTag("avt.jpg");
        //String s=cloudinary.url().imageTag("avt.jpg");
        Log.e(TAG, String.format("setBtSummit: phich %s", s) );
